 ...
 * Umrah Programs Page
 */
$pageTitle = 'برامج العمرة';
$pageDescription = 'اكتشف أفضل برامج العمرة مع لاند سكيب للسفر والسياحة - عمرة اقتصادية، عمرة VIP، عمرة رمضان';
$programs = getProgramsByType('umrah');
$categories = getCategoriesByType('umrah');
...
<section class="page-header">
    <div class="container">
        <h1 data-aos="fade-up">برامج العمرة</h1>
        <nav aria-label="breadcrumb" data-aos="fade-up" data-aos-delay="100">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?= BASE_URL ?>">الرئيسية</a></li>
                <li class="breadcrumb-item active">برامج العمرة</li>
            </ol>
        </nav>
    </div>
</section>
            ...
            <div class="row g-3 align-items-end">
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-select" id="filterPrice">
                        ...
                        <option value="0-15000">أقل من 15,000 ر.س</option>
                        <option value="15000-25000">15,000 - 25,000 ر.س</option>
                        <option value="25000-50000">25,000 - 50,000 ر.س</option>
                        <option value="50000-">أكثر من 50,000 ر.س</option>
                    </select>
                </div>
                <div class="col-md-4">
        ...
        <div class="row g-4">
            ...
            <?php else: ?>
                <div class="col-12 text-center py-5">
                    ...
                    <h4 class="text-muted">لا توجد برامج عمرة متاحة حالياً</h4>
